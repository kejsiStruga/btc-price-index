...
class App extends Component {
  constructor (props) {
    ...
    this.state = {historicalData: null, currency: "ALL"}
      ...
      return (
        <div className="app">
          ...
          <div className="select-container">
            ...
            {
              this.state.currency !== 'ALL' && (<div>
                <a href="#" className="link" onClick={() => this.setCurrency('ALL')} style={{color: "black", fontSize: 16, fontFamily: 'Bungee'}}> [CLICK HERE TO RESET] </a>
              </div>)
            }
          </div>
